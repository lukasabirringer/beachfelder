...
Vue.component('favorite', __webpack_require__(35));
var app = new Vue({
  el: '#app'
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        favorite: function favorite(beachcourt) {
            var _this = this;

            axios.post('/favorite/' + beachcourt).then(function (response) {
                return _this.isFavorited = true;
            }).catch(function (response) {
                return console.log(response.data);
            });
        },
        unFavorite: function unFavorite(beachcourt) {
            var _this2 = this;

            axios.post('/unfavorite/' + beachcourt).then(function (response) {
