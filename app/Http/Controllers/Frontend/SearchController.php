...
class SearchController extends Controller
{
  ...
  { 
    ...
    //Radio Value: kostenlos, einmaligeGebühr, zeitabhaengigeGebühr, dauerhafteMitgliedschaft oder egal // egal wird nicht weiter verarbeitet, da leer
    $cost = $request->cost;
    //when Kriterium 'kostenlos' dann suche danach
    if ($cost == 'kostenlos') {$results->where('isChargeable', '=', 1)->orWhereNull('isChargeable');}
