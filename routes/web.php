...
Route::group(['namespace' => 'Backend', 'middleware' => 'App\Http\Middleware\IsAdmin'], function () {
  ...
  Route::get('/backend/pages', 'PageController@index')->name('backendPage.index');
  Route::get('/backend/pages/{slug}', 'PageController@show')->name('backendPage.show');
  Route::get('/backend/pages/{slug}/bearbeiten', 'PageController@edit')->name('backendPage.edit');
