          ...
          <div class="column column--12 column--s-6 column--m-6 column--l-4 -spacing-b -flex">
            <div class="beachcourt-item">
              <div class="beachcourt-item__image">
                  <figure class="progressive">
                    <img class="progressive__img progressive--not-loaded" data-progressive="/uploads/beachcourts/{{$otherBeachcourt->id}}/slider/retina/slide-image-01-retina.jpg" src="/uploads/beachcourts/{{$otherBeachcourt->id}}/slider/standard/slide-image-01.jpg">
                  </figure>
                  @if (Auth::user())
                    <favorite
