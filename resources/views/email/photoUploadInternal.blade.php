	...
	<body>
		<div class="content">
			...
			<div class="content__main">
				<h1>Neuer Bild-Upload!</h1>

				<p>Wir haben einen neuen Bild-Upload zu dem Feld <br> <strong>#{{$beachcourt}} <br> {{$beachcourtZip}} {{$beachcourtCity}} <br> {{$beachcourtStreet}} {{$beachcourtHouseNumber}}</strong> <br>vom User <strong>{{$userName}}</strong> erhalten.</p>
